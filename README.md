# Gardening Days at Spinnaker Summit 2020

[Register here](https://go.armory.io/gardening) to join project contributors October 19 - November 12 to learn and build at Spinnaker Summit. All contributions you make in the 4-week hack period, including project and plugin code, documentation, content, videos, issues [and more](https://spinnaker.io/community/gardening/what-to-hack/), add up to points. All contributors will receive prizes based on their point totals, so contribute when you can. When you [sign up](https://go.armory.io/gardening), you'll enter the team matching process. Teams can choose compete in one [challenges](https://spinnaker.io/community/gardening/hack-logistics/#team-challenges) set by Armory, GitHub, AWS, and more. All teams that demo a project will be eligible for prize packages awarded to challenge-winning teams and runners-up in each challenge. 
